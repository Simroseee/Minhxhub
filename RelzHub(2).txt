...
local Main = Library:Tab("Main","rbxassetid://17583471021")
local Set = Library:Tab("Setting","rbxassetid://17583471021")
local Hold = Library:Tab("Hold Skill","rbxassetid://17583471021")
local M = Library:Tab("Items","rbxassetid://17583471021")
local Sea = Library:Tab("Sea","rbxassetid://17583471021")
local Ss = Library:Tab("Stats","rbxassetid://17583471021")
local RaceV4 = Library:Tab("Race","rbxassetid://17583471021")
local P = Library:Tab("Combat","rbxassetid://17583471021")
local R = Library:Tab("Raid","rbxassetid://17583471021")
local ESP = Library:Tab("Esp","rbxassetid://17583471021")
local T = Library:Tab("Teleport","rbxassetid://17583471021")
local S = Library:Tab("Shop","rbxassetid://17583471021")
local D = Library:Tab("Devil Fruit","rbxassetid://17583471021")
local Misc = Library:Tab("Misc","rbxassetid://17583471021")
local Serv = Library:Tab("Serv","rbxassetid://17583471021")
...
ESP:Toggle("Esp Gear", false,"Highlight Gear", function(value)
    ...
    task.spawn(function()
        ...
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
        KitsuneStatus:Set('â›©ï¸ Kitsune Island xuất hiện')
        else
        KitsuneStatus:Set('â›©ï¸ Kitsune Island ko xuất hiện') 
        end
            ...
            while wait(5) do
                pcall(function()
                        if GetLegendarySwordDealer() then
                            SwordDealer:Set('âš”ï¸ Legendary Sword Dealer xuất hiện')
                        else
                            SwordDealer:Set('âš”ï¸ Legendary Sword Dealer ko xuất hiện') 
                        end
